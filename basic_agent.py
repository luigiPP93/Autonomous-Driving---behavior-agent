...
two_wheeled_vehicle = ['vehicle.bh.crossbike', 'vehicle.diamondback.century', 'vehicle.gazelle.omafiets']
two_wheeled_dimension = {'x': 1.0, 'y': 0.65, 'z': 0.5}
...
class BasicAgent(object):
    ...
    def _get_ordered_vehicles(self, reference : carla.Actor, max_distance: float) -> list:
        ...
        vehicle_list.sort(key=lambda v: dist(v, self._vehicle))
        return vehicle_list
